...
#0.2	20160805	Added of Manufacturer / Product / Version tags
...
#start modprobe
echo "sudo modprobe g_mass_storage file=/dev/mapper/errdev0 stall=0 lun=1 ro=1 nofua=1 iProduct=FailDisk" >> /etc/rc.local
